    ...
    <div name="Contact" className="w-full h-full bg-gradient-to-b from-black to-gray-800 p-4 text-white">
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            <div className="pb-8">
                ...
                <p className="py-6">Leave me a message, I will get back to you! :)</p>
            </div>

            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/1b4bd5f9-947b-483a-aa31-876ba82eeda5" method="POST" className="flex flex-col w-full md:w-1/2">
                    ...
                    <button className="text-white bg-gradient-to-b from-cyan-700 via-green to-green-700 cursor-pointer px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300">Submit</button>
                </form>
            </div>
        </div>
    </div>
